...
class User extends Administrator implements JWTSubject
{
     ...
     * Using ASP.NET users table instead of admin_users for MRU authentication bridge.
     *
     * @var string
     */
     ...
     * Override parent constructor to ensure correct table is used.
     *
    ...
    public function __construct(array $attributes = [])
    {
        ...
        // Force the table to be my_aspnet_users for authentication bridge
    ...
    protected $fillable = [
        ...
        'name', 'username', 'email', 'password', 'password_laravel', 'remember_token',
        
        // Enterprise & system fields
        'enterprise_id', 'user_type', 'status', 'applicationId', 'isAnonymous', 
        'lastActivityDate', 'verification', 'demo_id', 'user_id', 'user_batch_importer_id',
        
        // Personal information
        'first_name', 'last_name', 'given_name', 'date_of_birth', 'place_of_birth',
        'sex', 'nationality', 'religion', 'marital_status', 'avatar',
        
        // Contact information
        'home_address', 'current_address', 'residence', 'phone_number_1', 'phone_number_2',
        ...
        // Additional fields
        'languages', 'main_role_id', 'account_id', 'has_personal_info', 
        'has_educational_info', 'has_account_info', 'lin', 'occupation',
        'last_seen', 'supervisor_id', 'user_number', 'token', 'roles_text',
        'plain_password', 'mail_verification_token', 'sign', 'is_enrolled',
    ];
    ...
    /**
     * Get the username attribute (ASP.NET uses 'name').
     */
     ...
     * Prioritize Laravel bcrypt password, fall back to ASP.NET.
     */
    public function getAuthPassword()
    {
        return $this->password_laravel ?? null;
    }
    
    /**
     * Get the ASP.NET membership record.
     */
    ...
    /**
     * Get the roles for the user from ASP.NET.
     */
    ...
    */
    ...
    public function bill_university_students()
    {
        ...
        // If student doesn't have a current class assigned, skip billing
        ...
        if ($current_class == null) {
            ...
            Log::warning("Current class not found for user: " . $this->name . " (ID: " . $this->id . ", class_id: " . $this->current_class_id . ")");
            return;
        }
