...
/**
 * Script to setup Mutesa I Royal University as the main enterprise
 */
...
echo "=== Setting up Mutesa I Royal University ===\n\n";
...
if (!$academicYear) {
    ...
    $academicYearId = DB::getPdo()->lastInsertId();
    ...
    $semester1Id = DB::getPdo()->lastInsertId();
