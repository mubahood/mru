...
<head>
    ...
    <link rel="icon" href="{{ $ent && $ent->logo ? url('storage/' . $ent->logo) : asset('assets/8tech.png') }}">
    ...
    <div class="login-box">
        ...
        <form action="{{ url('auth/login') }}" method="POST">
            ...
            <div class="form-footer">
                <a href="{{ url('auth/forgot-password') }}" class="link">Forgot Password?</a>
                <a href="{{ url('auth/support') }}" class="link">Need Help?</a>
            </div>
        </form>
    </div>
