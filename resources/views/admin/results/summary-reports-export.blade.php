    ...
    <div class="page-container">
        ...
        <div class="reports-grid">
            ...
            <div class="report-card vc" onclick="generateReport('vc-list')">
                ...
                <h3>First Class</h3>
                <div class="subtitle">First Class Honours<br>(Highest Achievement)</div>
            ...
            <div class="report-card dean" onclick="generateReport('deans-list')">
                ...
                <div class="subtitle">Second Class Upper Division</div>
                <div class="criteria">CGPA: 3.60 - 4.39</div>
                <button class="btn-generate">
                    <i class="fa fa-download"></i> Generate PDF
                </button>
            </div>
            ...
            <div class="report-card pass" onclick="generateReport('pass-cases')">
                ...
                <div class="subtitle">Second Class Lower Division</div>
                <div class="criteria">CGPA: 2.80 - 3.59</div>
                <button class="btn-generate">
                    <i class="fa fa-download"></i> Generate PDF
                </button>
            </div>
