...
<header class="main-header">
    ...
    <a href="<?php echo e(admin_url('/'), false); ?>" class="logo">
        ...
        <span class="logo-mini"><?php echo $ent->short_name; ?></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><?php echo $ent->short_name; ?></span>
    </a>
...
<?php /**PATH /Applications/MAMP/htdocs/mru/vendor/encore/laravel-admin/src/../resources/views/partials/header.blade.php ENDPATH**/ ?>