...
<?php $__env->startSection('title', ($company ? $company->name : 'Newline Technologies') . ' - School Management System | Complete Education Solution'); ?>
<?php $__env->startSection('meta_description', 'Transform your educational institution with our comprehensive school management system. Streamline operations, enhance communication, and improve student outcomes with advanced tools designed for modern schools.'); ?>
<?php $__env->startSection('meta_keywords', 'school management system, education software, student information system, school administration, academic management, teacher portal, parent communication, school operations, education technology, LMS'); ?>

<?php $__env->startSection('og_title', ($company ? $company->name : 'Newline Technologies') . ' - Complete School Management Solution'); ?>
<?php $__env->startSection('og_description', 'Revolutionary school management platform trusted by hundreds of educational institutions. Streamline operations, enhance communication, and boost academic excellence.'); ?>
<?php $__env->startSection('og_type', 'website'); ?>

<?php $__env->startSection('twitter_title', ($company ? $company->name : 'Newline Technologies') . ' - School Management System'); ?>
<?php $__env->startSection('twitter_description', 'Transform your school operations with our comprehensive management platform. Enhance communication and improve student outcomes.'); ?>
...
<script type="application/ld+json">
{
    ...
    "name": "<?php echo e($company ? $company->app_name : 'School Management System', false); ?>",
    ...
    "provider": {
        "@type": "Organization",
        "name": "<?php echo e($company ? $company->name : 'Newline Technologies', false); ?>",
        "url": "<?php echo e(url('/'), false); ?>",
    ...
    "screenshot": "<?php echo e($company && $company->logo ? Utils::img_url($company->logo) : Utils::get_logo(), false); ?>",
    "softwareVersion": "2024",
    "dateModified": "<?php echo e(date('Y-m-d'), false); ?>",
    "aggregateRating": {
...
<script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "<?php echo e($company ? $company->name : 'Newline Technologies', false); ?> - School Management System",
        ...
        <div class="hero-content">
            <div class="hero-text">
                <h1>
                    ...
                    <span class="highlight"><?php echo e($company ? $company->name : 'Newline Technologies', false); ?></span>
                </h1>
                <p>
            ...
            <div class="hero-image">
                <div class="logo-container">
                    <img src="<?php echo e($company && $company->logo ? Utils::img_url($company->logo) : Utils::get_logo(), false); ?>" 
                         alt="<?php echo e($company ? $company->name : 'Newline Technologies', false); ?> Logo"
                         width="200"
                         height="200"
                         loading="eager"
                         decoding="async">
    ...
    <div class="container">
        <div class="video-content">
            <div class="video-header text-center">
                <h2 class="video-title">See <?php echo e($company ? $company->app_name : 'Our System', false); ?> in Action</h2>
    ...
    <div class="container">
        ...
        <div class="pricing-footer">
            ...
            <div class="pricing-cta">
                <a href="<?php echo e(url('access-system'), false); ?>" class="btn btn-primary btn-large">
...
<?php echo $__env->make('layouts.modern-public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/mru/resources/views/landing/index.blade.php ENDPATH**/ ?>