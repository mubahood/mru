...
<div class="att-dashboard-container">
        ...
        <div class="col-md-4">
            <div class="att-table-container">
                <table class="att-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $secular_class_stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($stat->class_name ?? 'Unknown', false); ?></td>
                                <td><span
                                        class="att-badge att-badge-success"><?php echo e(number_format($stat->present_count), false); ?></span>
                                </td>
                                <td><span
                                        class="att-badge att-badge-danger"><?php echo e(number_format($stat->absent_count), false); ?></span>
                                </td>
                                <td>
                                    <div class="att-progress">
                                        <div class="att-progress-bar"
                                            style="width: <?php echo e($stat->attendance_rate, false); ?>%; background: var(--att-success-color);">
                                            <?php echo e(number_format($stat->attendance_rate, 1), false); ?>%
                                        </div>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="col-md-4">
            <div class="att-table-container">
                <table class="att-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $theology_class_stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($stat->class_name ?? 'Unknown', false); ?></td>
                                <td><span
                                        class="att-badge att-badge-success"><?php echo e(number_format($stat->present_count), false); ?></span>
    ...
    <div class="att-two-column">
        <div class="att-table-container">
            <table class="att-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $top_absent_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><strong><?php echo e($index + 1, false); ?></strong></td>
                            <td><?php echo e($student->display_name ?? ($student->student_name ?? 'Unknown'), false); ?></td>
                            <td><span
                                    class="att-badge att-badge-danger"><?php echo e(number_format($student->absent_count), false); ?></span>
                            </td>
                            <td><?php echo e(number_format($student->attendance_rate, 1), false); ?>%</td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
        ...
        <div class="att-table-container">
            <table class="att-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $top_present_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><strong><?php echo e($index + 1, false); ?></strong></td>
                            <td><?php echo e($student->display_name ?? ($student->student_name ?? 'Unknown'), false); ?></td>
                            <td><span
                                    class="att-badge att-badge-success"><?php echo e(number_format($student->present_count), false); ?></span>
                            </td>
                            <td><?php echo e(number_format($student->attendance_rate, 1), false); ?>%</td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="att-filter-container">
        <form method="GET" action="<?php echo e(route('.attendance.dashboard'), false); ?>" id="filterForm">
            <div class="att-filter-grid">
                <div class="att-filter-group">
                    <label class="att-filter-label">Start Date</label>
                    <input type="date" name="start_date" class="att-form-control" value="<?php echo e($start_date, false); ?>">
                </div>
                <div class="att-filter-group">
                    <label class="att-filter-label">End Date</label>
                    <input type="date" name="end_date" class="att-form-control" value="<?php echo e($end_date, false); ?>">
                </div>
                <div class="att-filter-group">
                    ...
                    <select name="term_id" class="att-form-control">
                        ...
                        <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($term->id, false); ?>" <?php echo e($term_id == $term->id ? 'selected' : '', false); ?>>
                                <?php echo e($term->name_text, false); ?>
                ...
                <div class="att-filter-group">
                    ...
                    <select name="class_id" class="att-form-control">
                        ...
                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($class->id, false); ?>" <?php echo e($class_id == $class->id ? 'selected' : '', false); ?>>
                                <?php echo e($class->name, false); ?>
                ...
                <div class="att-filter-group">
                    ...
                    <select name="attendance_type" class="att-form-control">
                        ...
                        <?php $__currentLoopData = $attendance_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type_key => $type_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type_key, false); ?>"
                                <?php echo e($attendance_type == $type_key ? 'selected' : '', false); ?>>
                                <?php echo e($type_name, false); ?>
    ...
    <script data-exec-on-popstate>
        ...
        function initializeCharts() {
            ...
            const genderData = <?php echo json_encode($gender_stats, 15, 512) ?>;
            ...
            const trendData = <?php echo json_encode($attendance_trend, 15, 512) ?>;
            ...
            const secularTheologyData = <?php echo json_encode($secular_theology_stats, 15, 512) ?>;
...
<?php /**PATH /Applications/MAMP/htdocs/mru/resources/views/admin/attendance-dashboard.blade.php ENDPATH**/ ?>