...
<div class="card  mb-4 mb-md-5 border-0">
    ...
    <div class="d-flex justify-content-between px-3 px-md-4 ">
        <h3 class="h3">
            <b>FEES COLLECTION - <?php echo e(count($labels), false); ?> DAYS AGO</b>
        </h3>
        <div>
...
<?php /**PATH /Applications/MAMP/htdocs/mru/resources/views/dashboard/fees_collection.blade.php ENDPATH**/ ?>