...
<head>
    ...
    <title><?php echo e($company->name ?? Utils::company_name(), false); ?> - Contact Support</title>
    
    <!-- Meta Tags -->
    <meta name="description" content="Get help with <?php echo e($company->app_name ?? Utils::app_name(), false); ?> school management system">
    <meta name="keywords" content="support, help, contact, <?php echo e($company->name ?? Utils::company_name(), false); ?>, school management">
    ...
    <style>
        :root {
            ...
            --primary-light: <?php echo e($company && $company->primary_color ? $company->primary_color : '#01AEF0', false); ?>15;
            --text-dark: #2d3748;
            --text-light: #718096;
            --text-muted: #a0aec0;
            --border-light: #e2e8f0;
    ...
    <div class="support-container">
        ...
        <div class="support-header">
            <div class="header-content">
                ...
                <p class="support-subtitle">
                    Our support team is here to assist you with any questions or issues you may have with the <?php echo e($company->app_name ?? Utils::app_name(), false); ?> school management system.
                </p>
            </div>
        </div>
        ...
        <div class="support-content">
                ...
                <div class="contact-methods">
                    <div class="contact-item">
                        ...
                        <div class="contact-info">
                            <h4>Phone Support</h4>
                            <p><?php echo e($company && $company->phone ? $company->phone : ($ent->phone ?? '+256 700 000 000'), false); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-info">
                            <h4>Email Support</h4>
                            <p><?php echo e($company && $company->email ? $company->email : ($ent->email ?? 'support@newlinetech.com'), false); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <p><?php echo e($ent->address ?: 'Kampala, Uganda', false); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-card" id="contact-form">
                ...
                <form method="POST" action="<?php echo e(url('auth/support'), false); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="Login Issues" <?php echo e(old('subject') == 'Login Issues' ? 'selected' : '', false); ?>>Login Issues</option>
                            <option value="Technical Support" <?php echo e(old('subject') == 'Technical Support' ? 'selected' : '', false); ?>>Technical Support</option>
                            <option value="Account Management" <?php echo e(old('subject') == 'Account Management' ? 'selected' : '', false); ?>>Account Management</option>
                            <option value="Feature Request" <?php echo e(old('subject') == 'Feature Request' ? 'selected' : '', false); ?>>Feature Request</option>
                            <option value="Bug Report" <?php echo e(old('subject') == 'Bug Report' ? 'selected' : '', false); ?>>Bug Report</option>
                            <option value="Other" <?php echo e(old('subject') == 'Other' ? 'selected' : '', false); ?>>Other</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                                  ...
                                  required><?php echo e(old('message'), false); ?></textarea>
...
</html><?php /**PATH /Applications/MAMP/htdocs/mru/resources/views/auth/support.blade.php ENDPATH**/ ?>